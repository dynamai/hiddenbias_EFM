...
The above message is valid for both neural and empirical FM sampler. The animations shown below are obtained with empirical FM samplers, which are the main focus of our paper:
